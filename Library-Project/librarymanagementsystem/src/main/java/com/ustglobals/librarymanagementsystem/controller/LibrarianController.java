...
public class LibrarianController {
	...
	@GetMapping(path="/delete-books/{bookId}",produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path="/issue-book/{regestrationId}/{bookId}", produces  = MediaType.APPLICATION_JSON_VALUE)
